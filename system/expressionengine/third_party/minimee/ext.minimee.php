	...
	public function get_settings()
	{
		...
		switch ($this->config_loc) :
			...
			case ('config') :
				...
				log_message('debug', 'Minimee has retrieved settings from config.');
			break;
			...
			case ('global') :
				...
				log_message('debug', 'Minimee has retrieved settings from global variables.');
			break;
			...
			default :
				...
				if ($query->num_rows() > 0)
				{
					...
					log_message('debug', 'Minimee has retrieved settings from DB.');
				}
				else
				{
					log_message('debug', 'Minimee has not yet been configured.');
				}
			break;
